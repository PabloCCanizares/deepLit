...
export const collectionSynthesisAPI = {
  runSynthesis: async (collectionId, prompt) => {
    return apiFetch(`/collection-synthesis/collections/${collectionId}/runs`, {
      method: 'POST',
  ...
  generatePaper: async (runId) => {
    return apiFetch(`/collection-synthesis/runs/${runId}/paper`, {
      method: 'POST',
    });
  },

  deleteRun: async (runId) => {
    return apiFetch(`/collection-synthesis/runs/${runId}`, {
      method: 'DELETE',
    });
  },
};
