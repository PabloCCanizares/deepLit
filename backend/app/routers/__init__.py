...
from app.routers import ai_assistant, auth, health, pdfs, excels, articles, stats, user, openalex, collections, knowledge_graph, screening, collection_synthesis, evidence_extraction, clustering, papers
